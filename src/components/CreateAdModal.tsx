        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <Select.Root onValueChange={setGameId}>
              ...
              <Select.Portal>
                <Select.Content className="bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 flex justify-between shadow-lg shadow-black/25">
                  <Select.Viewport className="flex flex-col gap-2">
                    {games.map(game => (
                      <Select.Item key={game.id} value={game.id} className="flex justify-between text-white py-3 px-4 rounded hover:bg-zinc-800">
